...
$res_comm = $db->executeQuery("SELECT * FROM rb_ex_commissioni_esame WHERE id_commissione = $id_comm");
$commissione = $res_comm->fetch_assoc();

$docenti = [];
$sel_teachers = "SELECT nome, cognome, uid, sostituto FROM rb_utenti, rb_ex_docenti_commissione_esame WHERE docente = uid AND commissione = {$id_comm}";
