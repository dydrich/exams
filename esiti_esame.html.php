...
<div id="drawer" class="drawer" style="display: none; position: absolute">
	<div style="width: 100%; height: 430px">
		...
		<div class="drawer_link submenu">
			<a href="../../intranet/teachers/registro_personale/scrutini.php?q=2"><img src="../../images/34.png" style="margin-right: 10px; position: relative; top: 5%"/>Scrutini</a>
		</div>
		<div class="drawer_link submenu"><a href="../../intranet/teachers/registro_personale/index.php"><img src="../../images/4.png" style="margin-right: 10px; position: relative; top: 5%" />Registro personale</a></div>
		...
		<div class="drawer_link submenu"><a href="../../intranet/teachers/registro_classe/registro_classe.php?data=<?php echo date("Y-m-d") ?>"><img src="../../images/28.png" style="margin-right: 10px; position: relative; top: 5%" />Registro di classe</a></div>
		<div class="drawer_link submenu separator"><a href="../../intranet/teachers/gestione_classe/classe.php"><img src="../../images/14.png" style="margin-right: 10px; position: relative; top: 5%" />Gestione classe</a></div>
...
<div id="other_drawer" class="drawer" style="height: 144px; display: none; position: absolute">
	<?php if (!isset($_REQUEST['__goals__']) && (isset($_SESSION['__user_config__']['registro_obiettivi']) && (1 == $_SESSION['__user_config__']['registro_obiettivi'][0]))): ?>
		<div class="drawer_link ">
			<a href="../../intranet/teachers/registro_personale/index.php?q=<?php echo $q ?>&subject=<?php echo $_SESSION['__materia__'] ?>&__goals__=1"><img src="../../../images/31.png" style="margin-right: 10px; position: relative; top: 5%"/>Registro per obiettivi</a>
		</div>
	<?php endif; ?>
	<?php if ($ordine_scuola == 1): ?>
		<div class="drawer_link">
			<a href="../../intranet/teachers/registro_personale/absences.php"><img src="../../images/52.png" style="margin-right: 10px; position: relative; top: 5%"/>Assenze</a>
		</div>
	<?php endif; ?>
	<div class="drawer_link">
		<a href="../../intranet/teachers/registro_personale/tests.php"><img src="../../images/79.png" style="margin-right: 10px; position: relative; top: 5%"/>Verifiche</a>
	</div>
	<div class="drawer_link">
		<a href="../../intranet/teachers/registro_personale/lessons.php"><img src="../../images/62.png" style="margin-right: 10px; position: relative; top: 5%"/>Lezioni</a>
	</div>

		<div class="drawer_link separator">
			<a href="../../intranet/teachers/registro_personale/scrutini_classe.php?q=2"><img src="../../images/34.png" style="margin-right: 10px; position: relative; top: 5%"/>Scrutini di classe</a>
		</div>
