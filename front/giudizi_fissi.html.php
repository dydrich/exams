...
<head>
	...
	<title>Gestione giudizi fissi</title>
	...
	<script type="text/javascript">
        $(function(){
            ...
            $('.edit').editable('upd_judgment.php', {
                indicator : 'Saving...',
...
<div id="main">
	...
	<div id="left_col">
        <div class="normal _bold accent_decoration" style="width: 85%; margin: 30px auto">Giudizi inseriti</div>
        <table style="width: 85%; margin: auto">
            <?php
            foreach ($grades as $k => $grade) {
                if ($grade == '') {
                    $grade = 'Click per inserire';
                }
				?>
                <tr style="height: 25px" class="bottom_decoration">
                    <td style="width: 10%"><?php echo $k ?></td>
                    <td style="width: 90%; text-align: center">
                        <p id="<?php print $k ?>" class="edit" style="margin: 0"><?php echo $grade ?></p>
                    </td>
                </tr>
				<?php
			}
