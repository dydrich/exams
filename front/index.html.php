...
<div id="main">
	...
	<div id="left_col">
		<div class="welcome">
			<p id="w_head">Calendario degli impegni</p>
			<?php
			foreach ($calendar as $date => $data) {
			?>
				<p class="<?php if ($data['assistenza'] == 1) echo '_bold normal' ?>"><?php echo format_date($date, SQL_DATE_STYLE, IT_DATE_STYLE, "/") ?>: <?php echo $data['prova'] ?></p>
			<?php
			}
			?>
		</div>
