...
$sel_voti = "SELECT rb_ex_voti_esame.* FROM rb_ex_voti_esame WHERE classe = ".$_SESSION['__classe__']->get_ID();
...
$presidente = $db->executeCount("SELECT presidente FROM rb_ex_dati_amministrativi_esame WHERE anno = {$anno}");
